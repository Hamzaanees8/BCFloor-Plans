...
const PublicTour = () => {
    ...
    return filtered.sort((a, b) => {
      const orderA =
        (a as any).sort_order !== undefined && (a as any).sort_order !== null
          ...
          : 999999;
      const orderB =
        (b as any).sort_order !== undefined && (b as any).sort_order !== null
          ? Number((b as any).sort_order)
          : 999999;
  ...
  useEffect(() => {
    if (!mainVideo && videoFiles.length > 0) {
      ...
      const videoUrl =
        videoFiles[0].url || `${API_URL}/${videoFiles[0].file_path}`;
