...
const ServiceReadyModal: React.FC<Props> = ({
    open,
    setOpen,
    showAgentModal,
    setShowAgentModal,
    ...
    const templateHTMLs: Record<string, string> = {
        service_ready: `
    <h1 style="font-size: 28px; font-weight: 400;">Service Ready</h1>
    <hr style="border: 0 !important; height: 1px !important; background-color: #CCCCCC !important;" />

    <p style="margin: 24px 0 16px">
      Hello ${orderData?.agent.first_name} ${orderData?.agent.last_name},
    </p>

    <p style="margin-bottom: 16px">
      We’re pleased to let you know that your requested service:
      <a href="#" style="color: #337ab7; text-decoration: none;">${serviceDate?.name}</a>
      for address
      <a href="#" style="color: #337ab7; text-decoration: none;">${orderData?.property_address}</a>
      <strong>has been completed.</strong>
    </p>

    <p style="margin-bottom: 16px">
      You can now access the files through the provided link:
      <a href="linkname/123141432" style="color: #337ab7; text-decoration: none;">linkname/123141432</a>
    </p>

    <p style="margin-bottom: 16px">
      If you ordered additional services on the same day, you may receive a separate email once those are completed and available for download.
    </p>
    ...
    <p style="font-size: 12px; color: #777; margin-top: 16px;">
      You received this email because you signed up on our website. This is an automated email.
      If you need to get in touch, email us at
      <a href="mailto:support@bcfpsoftware.com" style="color: #337ab7;">support@bcfpsoftware.com</a>.
...
export default ServiceReadyModal;
