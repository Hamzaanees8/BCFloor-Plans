...
import type { FeatureSheetResponse, FeatureSheetPayload, TextStyle } from "../types/featureSheetTypes";
...
const BcfpStandard10 = forwardRef<BcfpStandard10Ref, BcfpStandard10Props>(({ orderData }, ref) => {
  ...
  const [rotation, setRotation] = useState({
    image1: 0, image2: 0, image3: 0, image4: 0, image5: 0, image6: 0, image7: 0, image8: 0, image9: 0,
    image10: 0, image11: 0, image12: 0, image13: 0, image14: 0, image15: 0, image16: 0, image17: 0, image18: 0,
  });
  ...
  useEffect(() => {
    ...
    addressCode, roadName, cityLine, bedroom, bathroom, sqft, builtYear,
    images, scale, position, fieldStyles, updateFormData
  ]);
  ...
  useImperativeHandle(ref, () => ({
    ...
    importFromPayload: (payload: FeatureSheetResponse) => {
      ...
      if (state.keyHighlights) setSiteInfluences(Array.isArray(state.keyHighlights) ? state.keyHighlights.map(h => s(h)).join("\n") : s(state.keyHighlights));
