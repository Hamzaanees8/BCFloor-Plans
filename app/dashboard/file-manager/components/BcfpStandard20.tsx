  ...
  ({ orderData }, ref) => {
    ...
    const renderImageSlot = (key: string, label: string = "Select Image") => (
      ...
      >
        {images[key] ? (
          ...
          <div
            onClick={() => openImageSourceModal(key)}
            className={`w-full h-full text-gray-500 flex items-center justify-center cursor-pointer border ${key === "image8" ? "border-dashed border-gray-400 bg-white/10 text-gray-300" : "border-none bg-[#e2e8f0]"}`}
          >
            {label}
          </div>
        )}
        ...
        <div className="relative z-10 flex flex-col justify-center gap-2 w-full max-w-[60%]">
          ...
          <div className="flex items-center gap-1 font-light text-[21px] text-[#ffffff] leading-none">
            ...
            <StyledInput
              ...
              className="w-[140px] ml-1 bg-transparent text-[#ffffff] font-light text-[21px] focus:outline-none placeholder-[#ffffff] placeholder:font-[200]"
            ...
            <StyledInput
              ...
              onChangeStyle={(s) => updateFieldStyle("suite", s)}
              className="w-[60px] text-center bg-transparent text-[#ffffff] font-light text-[21px] focus:outline-none placeholder-[#ffffff] placeholder:font-[200]"
              placeholder="0"
            />
            <span className="mr-1">ROAD</span>
          </div>
          ...
          <div className="flex items-center justify-between pr-4 mt-2">
            <StyledInput
              ...
              className="w-[350px] bg-transparent text-[#ffffff] text-[15px] tracking-widest uppercase focus:outline-none placeholder-[#ffffff] placeholder:font-[200]"
            ...
            <StyledInput
              ...
              className="w-[120px] bg-transparent text-[#ffffff] text-[18px] font-semibold text-center focus:outline-none placeholder-[#ffffff] placeholder:font-[500]"
              placeholder="$000,000"
            />
          </div>
        </div>
    ...
    return (
      <>
        ...
        {/* Page 1 */}
        <div className="pdf-page w-[8.5in] h-[11in] bg-[#fbfbfb] relative overflow-hidden flex flex-col  shadow-xl font-serif">
          ...
          <div className="relative z-10 flex-1 flex flex-col">
            ...
            <div className="flex w-full px-[35px] py-[25px] gap-[25px] flex-1">
              ...
              <div className="w-[65%] flex flex-col h-full text-black">
                ...
                <div className="flex flex-nowrap whitespace-nowrap font-semibold text-[13px] items-center mb-3 justify-center uppercase text-black">
                  <div className="w-[15px] flex items-center justify-center">
                    <StyledInput
                      ...
                      className="w-full bg-transparent text-center focus:outline-none placeholder-gray-600 font-semibold"
                      placeholder="0"
                    />
                  </div>
                  <span className="ml-[3px] text-[10px] tracking-widest">
                    BEDROOM
                  </span>{" "}
                  <span className="text-[12px] text-black mx-[6px]">·</span>
                  <div className="w-[15px] flex items-center justify-center">
                    <StyledInput
                      value={bathroom}
                  ...
                  <span className="text-[12px] text-black mx-[6px]">·</span>
                  <span className="mr-[3px] text-[10px] tracking-widest">
                    BUILT IN
                  </span>
                ...
                <div className="mb-4">
                  <StyledInput
                    ...
                    rows={6}
                    className="text-[12px] text-black text-left w-full bg-transparent focus:outline-none resize-none placeholder-gray-600 italic leading-[1.4]"
                ...
                <div className="flex flex-col gap-1 text-[13px] text-black w-full">
                  <div className="flex items-start w-full">
                    <span className="font-bold mr-2 shrink-0 uppercase">
                      BY-LAW RESTRICTIONS:
                    </span>
                    <StyledInput
                      ...
                      rows={1}
                      className="flex-1 bg-transparent text-[14px] focus:outline-none placeholder-gray-600 text-black leading-tight"
                ...
                {/* Contact & Price Block */}
                <div className="flex flex-row items-start justify-between w-full pb-2 mt-3">
                  <div className="flex flex-col text-[13px] text-black leading-snug w-[60%]">
                    <div className="flex items-center">
                      ...
                      <StyledInput
                        ...
                        className="uppercase font-bold bg-transparent focus:outline-none placeholder-gray-600 w-full"
                    ...
                    <StyledInput
                      ...
                      className="bg-transparent focus:outline-none placeholder-gray-600 w-full"
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <StyledInput
                        ...
                        className="bg-transparent text-[16px] focus:outline-none placeholder-gray-600 w-full"
                  ...
                  <div className="text-[44px] font-normal text-black leading-none pb-1 w-[40%] flex justify-end">
                    <StyledInput
                      ...
                      inputStyle={fieldStyles.amount}
                      onChangeStyle={(s) => updateFieldStyle("amount", s)}
                      className="bg-transparent focus:outline-none placeholder-gray-600 w-full text-right"
                      placeholder="$000,000"
                    />
                  </div>
                </div>
              ...
              <div className="w-[35%] flex flex-col gap-3 h-full pb-[10px]">
                <div className="w-full h-[145px] bg-[#e2e8f0] relative shadow-md border-[3px] border-white">
                  {renderImageSlot("image2")}
                </div>
                <div className="w-full h-[145px] bg-[#e2e8f0] relative shadow-md border-[3px] border-white">
                  {renderImageSlot("image3")}
                </div>
                <div className="w-full h-[145px] bg-[#e2e8f0] relative shadow-md border-[3px] border-white">
                  {renderImageSlot("image4")}
                </div>
                <div className="w-full h-[145px] bg-[#e2e8f0] relative shadow-md border-[3px] border-white">
                  {renderImageSlot("image5")}
                </div>
                <div className="w-full h-[145px] bg-[#e2e8f0] relative shadow-md border-[3px] border-white">
                  {renderImageSlot("image6")}
                </div>
              </div>
            </div>
          </div>
