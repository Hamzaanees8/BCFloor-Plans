  ...
  ({ orderData }, ref) => {
    ...
    return (
      <div className="w-full items-center justify-center relative font-alexandria">
        ...
        <div className="bg-[#8D110A]">
          <div className="absolute top-5 items-center gap-2 z-10 flex flex-col self-center left-1/2 transform -translate-x-1/2">
            <div className="flex flex-col items-center">
              <div className="text-[28px] font-light leading-none mt-0 text-[#8D110A] flex justify-center ">
                ...
                <span className="inline">
                  <StyledInput
                    ...
                    className="font-light text-[28px] h-[30px] w-[150px] leading-none mt-0 bg-transparent text-[#8D110A] text-left focus:outline-none border-none placeholder-[#8D110A] placeholder:font-[200]"
                    placeholder="0000-0000"
                  />
                </span>
                <span className="text-[#8D110A] flex uppercase">
                  Number
                  <StyledInput
                    value={roadName}
                    ...
                    className="font-light text-[28px] h-[30px] leading-none mt-0 bg-transparent text-[#8D110A] text-center w-[65px] focus:outline-none border-none placeholder-[#8D110A] placeholder:font-[200]"
                    placeholder="0"
                  />
                  Road
                </span>
            ...
            <div className="flex justify-between">
              <div className="text-[#2C2E35] text-[10px] justify-self-center">
                <StyledInput
                  value={cityLine}
                  onChange={(e) => setCityLine(e.target.value)}
                  inputStyle={fieldStyles["cityLine"]}
                  onChangeStyle={(s) => updateFieldStyle("cityLine", s)}
                  className="text-[#2C2E35] text-[14px] h-[20px] bg-transparent text-center w-[250px] focus:outline-none border-none placeholder-[#2C2E35] placeholder:font-[200]"
          ...
          <div
            className="h-[700px] w-full group border-2 border-b-[#8D110A] relative overflow-hidden"
          ...
          <div className="grid grid-cols-4 ">
            <div
              className="h-[230px] w-full group border-2 border-[#8D110A] relative overflow-hidden"
          ...
          <div className=" relative">
            ...
            <div className=" w-full py-2 place-items-center place-self-center">
              <div className="font-bold text-[24px] text-[#ffffff] flex flex-wrap items-center gap-2">
                ...
                <div className="inline">
                  <StyledInput
                    ...
                    className="font-semibold text-[24px] bg-transparent text-left h-[20px] w-[full] focus:outline-none border-none placeholder-white placeholder:font-[500]"
                    placeholder="$000,000"
                  />
                </div>
              </div>
            ...
            <div className="flex gap-4 px-[80px] pt-[15px]">
              <div className="w-[55%]">
                <div className="text-[10px] w-full justify-self-center  font-normal text-[#ffffff] italic relative z-10 leading-[1.6]">
                  <StyledInput
                    value={description}
                    rows={7}
          ...
          <div className="relative mt-[35px]">
            <div className="absolute top-[105px] right-[170px] group z-20">
              <div
        ...
        <div className="relative w-full flex flex-col group bg-[#8D110A]">
          ...
          <div className="relative mt-[35px] bottom-[-2px]">
            <svg
              viewBox="163 79 631 114"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
