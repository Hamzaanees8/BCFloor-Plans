        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/orders/edit/properties/${orderData.property.uuid}`, {
                ...
                body: JSON.stringify({
                    ...
                    map_zoom: orderData?.property?.map_zoom,
                    map_type: orderData?.property?.map_type,
                    map_center_lat: orderData?.property?.map_center_lat,
                    map_center_lng: orderData?.property?.map_center_lng,
