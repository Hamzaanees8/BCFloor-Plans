...
const Service: React.FC<Props> = ({ orderData, currentService }) => {
    const { floorFiles, setFloorFiles } = useFileManagerContext();
    ...
    return (
        <div>
            <div className='w-full justify-between h-[65px] bg-[#E4E4E4] font-alexandria pr-5 z-10 flex items-center border-b border-[#BBBBBB] px-6' >
                <Button onClick={() => fileInputRef.current?.click()} className='w-[150px] md:w-[143px] h-[32px] md:h-[32px]  justify-center rounded-[6px] font-raleway border-[1px] border-[#4290E9] bg-[#4290E9] text-[14px] md:text-[16px] font-[600] text-[#EEEEEE] flex gap-[5px] items-center hover:text-[#fff] hover:bg-[#4290E9]'>Add File</Button>
                <p className='text-[16px] font-bold text-[#4290E9]'>2D Floor Plans</p>
                {dragging && (
            ...
            <div className='px-[200px] pt-[54px]'>
                <div className='px-[80px] pb-[60px] gap-y-6'>
                    <p className='font-semibold text-lg text-[#4290E9] uppercase'>Square Footage</p>
                    ...
                    <div className='flex items-center justify-end pt-6'>
                        <Button onClick={() => setOpen(true)} className='w-[150px] md:w-[143px] h-[32px] md:h-[32px]  justify-center rounded-[6px] font-raleway border-[1px] border-[#4290E9] bg-[#4290E9] text-[14px] md:text-[16px] font-[600] text-[#EEEEEE] flex gap-[5px] items-center hover:text-[#fff] hover:bg-[#4290E9]'>Edit</Button>
                    </div>
                </div>
            </div>
            {floorFiles.length == 0 && <div className='w-full py-[54px] flex justify-center'>
