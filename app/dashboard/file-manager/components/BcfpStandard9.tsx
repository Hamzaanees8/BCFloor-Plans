  ...
  ({ orderData }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      ...
      importFromPayload: (payload: FeatureSheetResponse) => {
        ...
        if (state.expandedDetail2Description)
          setMaintenanceFees(s(state.expandedDetail2Description));
        if (state.expandedDetail3Description)
          setMaintenanceFeesInclude(s(state.expandedDetail3Description));
    ...
    return (
      <div className="w-full flex flex-col items-center justify-center font-alexandria py-8 gap-0">
        ...
        {/* PAGE 1 Sheet */}
        <div
          className="flex items-stretch pdf-page shadow-[0_10px_25px_rgba(0,0,0,0.15)] relative overflow-hidden"
          style={{
            width: "17in",
            height: "11in",
            zoom: 0.55,
        ...
        >
          ...
          >
            {/* image1 */}
            <div className="h-[640px] w-full relative overflow-hidden group">
              <div
                ...
                {images.image1 ? (
                  <>
                    ...
                    <button
                      ...
                      className="absolute top-[110px] right-[72px] bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto print:hidden z-20"
                      title="Rotate image"
                    >
                    ...
                    <button
                      ...
                      className="absolute top-[110px] right-10 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto z-20"
                      title="Edit image"
                    >
                    ...
                    <button
                      ...
                      className="absolute top-[110px] right-2 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto z-20"
                      title="Delete image"
                    >
            ...
            {/* image2 logo */}
            <div className="my-3 w-[200px] h-[100px] relative group overflow-hidden">
              <div
                className="w-full h-full relative overflow-hidden flex items-center justify-center"
                ...
                {images.image2 ? (
                  <>
                    ...
                    <button
                      ...
                      className="absolute top-2 right-[72px] bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto print:hidden z-20"
                      title="Rotate image"
                    >
                      <RotateCw className="w-4 h-4 text-gray-700" />
                    </button>
                    ...
                    <button
                      ...
                      className="absolute top-2 right-10 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto z-20"
                      title="Edit image"
                    >
                      <Pencil className="w-4 h-4 text-gray-700" />
                    </button>
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto z-20"
                      title="Delete image"
                    >
                      <Trash className="w-4 h-4 text-red-500" />
                    </button>
              ...
              <div>
                <div className="font-semibold text-[20px] flex gap-3">
                  ...
                  <StyledInput
                    ...
                    className="text-[16px] h-[16px] mt-2 bg-transparent text-left w-full focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
          ...
          <div className="w-1/2 bg-gray-200 relative overflow-hidden flex items-center justify-center group">
            ...
            {/* image3 */}
            <div className="w-full h-full justify-center content-center relative overflow-hidden group">
              <div
                className="w-full h-full relative overflow-hidden flex items-center justify-center"
                ...
                {images.image3 ? (
                  <>
                    ...
                    <button
                      ...
                      className="absolute z-[22] top-1/3 right-[72px] bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto print:hidden"
                      title="Rotate image"
                    >
                      <RotateCw className="w-4 h-4 text-gray-700" />
                    </button>
                  ...
                  <div
                    onClick={() => openImageSourceModal("image3")}
                    className="w-full relative z-10 h-[500px] text-gray-600 flex items-center justify-center cursor-pointer border border-dashed border-gray-400 bg-gray-200"
                  >
                    Select Image
                  </div>
                )}
            ...
            <div className="absolute bottom-2 right-0 left-3 z-20">
              <div className="my-3 w-[200px] h-[100px] relative overflow-hidden group">
                <div
                  className="w-full h-full relative overflow-hidden flex items-center justify-center"
        ...
        >
          <div className="flex items-stretch h-full relative bg-[#B3B394] w-full">
            ...
            <div className="flex gap-4 z-10 items-stretch absolute top-0 left-0 right-0 bottom-0 p-[50px]">
              <div className="w-1/2 h-full flex flex-col gap-4">
                {/* image5 */}
                <div className="w-full h-[445px] bg-white border-[2px] border-white shadow-sm place-self-center relative overflow-hidden group">
                  <div
                    className="w-full h-full relative overflow-hidden flex items-center justify-center"
                  ...
                  >
                    {images.image5 ? (
                      <>
                        ...
                        <button
                          ...
                          className="absolute top-5 right-[72px] z-20 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto print:hidden"
                          title="Rotate image"
                        >
                          <RotateCw className="w-4 h-4 text-gray-700" />
                        </button>
                        ...
                        <button
                          ...
                          className="absolute top-5 right-10 z-20 bg-white p-1 rounded-full hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto shadow"
                          title="Edit image"
                        >
                          <Pencil className="w-4 h-4 text-gray-700" />
                        </button>
                        <button
                          ...
                          className="absolute top-5 right-2 z-20 bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"
                          title="Delete image"
                        >
                          <Trash className="w-4 h-4 text-red-500" />
                        </button>
                    ...
                    <div className="absolute top-4 place-items-center w-[80%] m-auto place-self-center z-10 pointer-events-auto">
                      ...
                      <div className="font-bold text-[14px] text-[#2C2E35] flex flex-wrap gap-2 justify-center">
                ...
                <div className="flex gap-4">
                  {/* image6 */}
                  <div className="w-1/2 h-[200px] border-2 border-[#fff] relative overflow-hidden group">
                    <div
                      className="w-full h-full relative overflow-hidden flex items-center justify-center"
                ...
                <div className="flex gap-4">
                  {/* image8 */}
                  <div className="w-1/2 h-[300px] border-2 border-[#fff] relative overflow-hidden group">
                    <div
                      className="w-full h-full relative overflow-hidden flex items-center justify-center"
              ...
              <div className="w-1/2 h-full flex gap-3">
                <div className="absolute top-[50px] right-[50px] z-10 text-right w-[300px] flex flex-col gap-0 items-end">
                  ...
                  <StyledInput
                    ...
                    rows={1}
                    onChangeStyle={(style) =>
                      updateFieldStyle("maintenanceFees", style)
                    }
                  ...
                  <StyledInput
                    ...
                    rows={2}
                    onChangeStyle={(style) =>
                      updateFieldStyle("maintenanceFeesInclude", style)
                    }
                  ...
                  <StyledInput
                    ...
                    className="font-semibold text-white text-[8px] bg-transparent text-right h-[15px] min-h-[10px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[500]"
                    placeholder="South & SW - van island"
                  />
                </div>
                ...
                <div className="w-1/2">
                  <div className="grid grid-cols-1 gap-4">
                    {/* image9 */}
                    <div className="w-full h-[210px] relative border-2 border-[#fff] bg-white shadow-md group overflow-hidden">
                      <div
                        className="w-full h-full relative overflow-hidden flex items-center justify-center"
                ...
                <div className="w-1/2 flex flex-col justify-end">
                  <div className="w-full h-[500px] relative border-2 border-[#fff] bg-white shadow-md group overflow-hidden">
                    <div
                      className="w-full h-full relative overflow-hidden flex items-center justify-center"
