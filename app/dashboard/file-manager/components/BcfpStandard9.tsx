...
import type { FeatureSheetResponse, FeatureSheetPayload, TextStyle, StyledTextField } from "../types/featureSheetTypes";
...
const BcfpStandard9 = forwardRef<BcfpStandard9Ref, BcfpStandard9Props>(({ orderData }, ref) => {
  ...
  useEffect(() => {
    ...
    if (formData) {
      ...
      if (formData.maintenanceFeesInclude) setMaintenanceFeesInclude(s(formData.maintenanceFeesInclude));
