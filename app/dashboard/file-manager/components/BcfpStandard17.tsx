...
const BcfpStandard17 = forwardRef<BcfpStandard17Ref, BcfpStandard17Props>(
  ({ orderData }, ref) => {
    ...
    const handleRotate = (key: keyof typeof rotation) => {
      setRotation((prev) => ({
        ...prev,
        [key]: (prev[key] + 90) % 360,
      }));
    ...
    const handleZoom = (key: keyof typeof images, direction: "in" | "out") => {
      setScale((prev) => {
        ...
        const bounded = Math.min(Math.max(newScale, 0.2), 3);
      ...
      <>
        ...
        <div className="pdf-page w-[8.5in] h-[11in] relative overflow-hidden flex flex-col bg-white">
          <div className="bg-[#2B612A] relative flex-1 h-full font-alexandria">
                ...
                <div className="text-[28px] font-light leading-none mt-0 text-white flex justify-center items-center">
                  ...
                  <span className="inline">
                    <StyledInput
                      ...
                      className="font-light text-[28px]  w-[150px]  mt-0 bg-transparent text-white text-left focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
                      placeholder="0000-0000"
                    />
                  </span>
                  <span className="text-white flex uppercase items-center">
                    Number
                    <StyledInput
                      value={roadName}
                      ...
                      className="font-light text-[28px]   mt-0 bg-transparent text-white text-center w-[85px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
                      placeholder="0"
                    />
                    Road
                  </span>
              ...
              <div className="flex justify-end ">
                <div className="text-white text-[10px] justify-self-center">
                  <StyledInput
                    ...
                    className="text-white text-[16px] h-[20px] bg-transparent text-right w-[350px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
              ...
              <div className="font-bold items-center text-[14px] text-[#B3B394] flex flex-wrap gap-2">
                <div className="">
                  <StyledInput
                    ...
                    className="font-semibold text-[13px] bg-transparent text-left w-[20px] h-full focus:outline-none border-none placeholder-gray-300 placeholder:font-[500]"
                    placeholder="0"
                  />
                </div>
                BEDROOM |
                ...
                <div className="inline">
                  <StyledInput
                    ...
                    className="font-semibold text-[13px] bg-transparent text-left h-full w-[45px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[500]"
                    placeholder="000"
                  />
                </div>
                SQ FT | BUILT IN
            ...
            <div
              className="h-[450px] w-full group border-[#fff] relative overflow-hidden"
            ...
            <div className="flex gap-4 px-[40px] pb-[20px]">
              <div className="w-[75%]">
                <div className="mt-[-40px] relative z-10">
                  ...
                  <div className="text-[10px] justify-self-center mt-4 w-full font-normal text-[#ffffff] italic relative z-10 leading-[1.6]">
                    <h2 className="text-[16px] px-0 text-center tracking-[-1px] leading-loose font-bold text-[#B3B394] line-clamp-2">
                    ...
                    <div className="relative px-4 py-2 z-2  gap-2 flex justify-self-center text-[#B3B394]">
              ...
              <div className="w-[25%]">
                ...
                <div className="space-y-2 mt-4 text-[8px]">
                  <div>
                  ...
                  <div className="w-full">
                    <div className="flex gap-2 text-white text-[12px]">
                      ...
                      <StyledInput
                        ...
                        rows={1}
                        className="font-thin  text-[12px] h-[22px] bg-transparent text-left w-[250px] focus:outline-none border-none placeholder-white placeholder:font-[500]"
                    ...
                    <div className="flex gap-2 text-white text-[11px] ">
                      ...
                      <StyledInput
                        ...
                        rows={1}
                        className="font-thin text-[11px] h-[22px] bg-transparent text-left w-full focus:outline-none border-none placeholder-white placeholder:font-[500]"
        ...
        <div className="pdf-page w-[8.5in] h-[11in] relative overflow-hidden flex flex-col bg-white">
          <div className="relative bg-[#2B612A] w-full flex-1 h-full flex flex-col group p-10 font-alexandria">
            <div className="flex flex-col self-end bg-[#2B612A]">
              <div className="flex flex-col items-center">
                <div className="text-[28px] font-light leading-none mt-0 text-white flex justify-center items-center">
                  <span className="text-[16px]">#</span>
                  <span className="inline">
                  ...
                  <span className="text-white flex uppercase items-center">
                    ...
                    <StyledInput
                      ...
                      inputStyle={fieldStyles["roadName"]}
                      onChangeStyle={(s) => updateFieldStyle("roadName", s)}
                      className="font-light text-[28px]   mt-0 bg-transparent text-white text-center w-[65px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
                      placeholder="0"
                    />
                    Road
                  </span>
              ...
              <div className="flex justify-end ">
                <div className="text-white text-[10px] justify-self-center">
                  <StyledInput
                    ...
                    inputStyle={fieldStyles["cityLine"]}
                    onChangeStyle={(s) => updateFieldStyle("cityLine", s)}
                    className="text-white text-[18px]  bg-transparent text-right w-[500px] focus:outline-none border-none placeholder-gray-300 placeholder:font-[200]"
                    placeholder="BRIGHOUSE SOUTH, RICHMOND"
                  />
                </div>
              </div>
            ...
            <div className="relative flex-1 mt-4 w-full h-full min-h-0 self-center">
              <div
                className="w-full h-full overflow-hidden flex justify-center items-center transition-all duration-200 group bg-white relative"
              ...
              >
                {images.image8 ? (
                  <>
                    <div
                      className="w-full h-full cursor-grab active:cursor-grabbing bg-[#2B612A]"
                      onMouseDown={(e) => handleMouseDown("image8", e)}
                    >
                      <ImageEditor
                        src={images.image8}
                    ...
                    <button
                      ...
                      className="absolute z-[22] top-3 right-[112px] bg-white p-1 rounded-full shadow hover:bg-gray-100 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"
                      title="Rotate image"
                    >
