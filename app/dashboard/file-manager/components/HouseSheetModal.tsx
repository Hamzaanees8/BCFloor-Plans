...
const HouseSheetModal: React.FC<Props> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-[95vw] md:w-[730px] max-w-[95vw] md:max-w-[730px] p-4 md:p-6 h-[85vh] md:h-[650px] max-h-[85vh] overflow-hidden flex flex-col justify-between rounded-[8px] font-alexandria [&>button]:hidden">
