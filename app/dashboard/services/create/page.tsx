              ...
              <div className="grid grid-cols-2 gap-[16px]">
                <div className="col-span-2 grid grid-cols-5 gap-2 items-start">
                  <div className="col-span-3 flex flex-col">
                    <label className="col-span-1 text-sm mt-[18px]">
          ...
          >
            ...
            {categoryObject?.name.toLocaleLowerCase() !== "package" && (
              <AccordionItem value="options" className="relative group !mt-0">
                <p
                  onClick={addOption}
                  className="text-[#4290E9] flex gap-[10px] cursor-pointer items-center absolute right-[75px] top-[20px] group-data-[state=closed]:hidden"
                >
                  Add
                  <span className="flex bg-[#4290E9] w-[18px] h-[18px] rounded-[3px] justify-center items-center">
                ...
                <AccordionContent className="grid gap-4 !pb-0 overflow-x-auto">
                  <div className="w-full flex flex-col items-center mb-[40px]">
                    <Table className='font-alexandria !overflow-x-auto whitespace-nowrap min-w-[800px]"'>
                      <TableHeader style={{ backgroundColor: `var(--${userType}-page-bg, #E4E4E4)` }}>
                    ...
                    {categoryObject?.add_ons && (
                      <div className="w-full">
                        ...
                        <div className="flex justify-between items-center px-[20px]">
                          <h1 className="flex text-center text-[#4290E9] text-[18px] my-[20px]">
                            ADD ONS
                          </h1>
                          <p
                            onClick={handleAddRow}
                            className="text-[#4290E9] flex gap-[10px] cursor-pointer items-center  group-data-[state=closed]:hidden"
                          >
                            Add
                            <span className="flex bg-[#4290E9] w-[18px] h-[18px] rounded-[3px] justify-center items-center">
                              <Plus className="text-[#F2F2F2] w-[12px]" />
                        ...
                        <Table>
                          <TableHeader className="text-[#666666]" style={{ backgroundColor: `var(--${userType}-page-bg, #E4E4E4)` }}>
                            <TableRow>
