...
export default function AddBreakPopup({
    ...
    useEffect(() => {
        if (currentBreak) {
            ...
            setFromTime(currentBreak.start_time?.slice(0, 5) || '09:00');
            setToTime(currentBreak.end_time?.slice(0, 5) || '10:00');
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="bg-[#E4E4E4] w-[370px] md:w-[650px] max-w-none !rounded-none font-alexandria">
                ...
                <DialogFooter className="mt-4 font-alexandria">
                    <Button
                        className={`bg-white w-full md:w-[170px] h-[44px] text-[20px] font-[400] border ${userType}-border ${userType}-text hover-${userType}-bg hover:text-[#fff]`}
                        variant="outline"
