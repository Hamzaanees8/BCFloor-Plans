    ...
    const handleSubmitOrder = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        const slotsPayload = validSlots.map((slot) => {
            return {
                ...
                ...(slot.custom_duration !== undefined && slot.custom_duration !== null ? { custom_duration: slot.custom_duration } : {}),
                ...(slot.custom_end_time ? { custom_end_time: slot.custom_end_time } : {}),
                ...(slot.buffer_minutes !== undefined && slot.buffer_minutes !== null ? { buffer_minutes: slot.buffer_minutes } : {}),
