    ...
    <div className="flex flex-col w-full bg-white shadow-sm hover:shadow-md transition-all duration-200 rounded-lg overflow-hidden border border-gray-100 group relative">
      ...
      >
        ...
        {type === 'listing' && (KanbanViewCard as any).publicTourUrl && (
          <a
            href={(KanbanViewCard as any).publicTourUrl}
            target="_blank"
            rel="noopener noreferrer"
            onClick={(e) => e.stopPropagation()}
            className="absolute top-2 right-2 bg-black/60 hover:bg-emerald-600 text-white p-1.5 rounded-full backdrop-blur-md shadow-sm border border-white/20 transition-all flex items-center justify-center group/tourbtn"
