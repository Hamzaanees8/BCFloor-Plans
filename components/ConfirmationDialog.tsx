...
import React from "react" // Add useEffect and useState
import {
  AlertDialog,
  AlertDialogContent,
  AlertDialogHeader,
...
const ConfirmationDialog: React.FC<Props> = ({
  ...
  const handleCheckboxChange = () => {
    ...
    localStorage.setItem(getStorageKey(dialogType), JSON.stringify(newValue));
  }
      ...
      <AlertDialogContent className="w-[320px] md:w-[593px] rounded-[8px] p-4 md:p-6 gap-[10px] font-alexandria">
        ...
        <div className="mt-4 flex items-center gap-2 border-b-[1px] border-[#E4E4E4] pb-2">
          <input
            ...
            id="no-show"
            checked={!showAgain}
            onChange={handleCheckboxChange} // CHANGED THIS!
